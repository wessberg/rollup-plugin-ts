...
export function visitObjectBindingPattern({node, continuation, compatFactory}: TreeShakerVisitorOptions<TS.ObjectBindingPattern>): TS.ObjectBindingPattern | undefined {
