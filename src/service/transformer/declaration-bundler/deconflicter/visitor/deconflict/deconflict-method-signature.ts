...
export function deconflictMethodSignature({
	...
	lexicalEnvironment,
	typescript
}: DeconflicterVisitorOptions<TS.MethodSignature>): TS.MethodSignature | undefined {
	...
	return typescript.updateMethodSignature(node, typeParametersContResult, parametersContResult, typeContResult, nameContResult, node.questionToken);
}
