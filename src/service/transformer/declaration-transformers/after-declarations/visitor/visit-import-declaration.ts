 ...
 * @param {AfterDeclarationsVisitorOptions<ImportDeclaration>} options
...
}: AfterDeclarationsVisitorOptions<ImportDeclaration>): ImportDeclaration | VariableStatement | undefined {
