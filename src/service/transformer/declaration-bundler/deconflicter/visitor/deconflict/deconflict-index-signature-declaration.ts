...
export function deconflictIndexSignatureDeclaration({
	...
	lexicalEnvironment,
	typescript
}: DeconflicterVisitorOptions<TS.IndexSignatureDeclaration>): TS.IndexSignatureDeclaration | undefined {
	...
	return typescript.updateIndexSignature(node, node.decorators, node.modifiers, parametersContResult, typeContResult!);
}
