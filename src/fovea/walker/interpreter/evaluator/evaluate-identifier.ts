 ...
 * @returns {Literal}
 */
export function evaluateIdentifier ({node, initialEnvironment, environment, continuation, context}: IEvaluatorOptions<Identifier>): Literal {
	...
	if (valueDeclaration != null) {
		...
		const result = continuation.run(valueDeclaration, environmentForValueDeclaration);
